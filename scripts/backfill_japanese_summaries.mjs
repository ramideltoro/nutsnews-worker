...
/**
 * Backfill Japanese NutsNews article summaries.
 *
 * Required env:
 *   SUPABASE_URL
      ...
      messages: [
        {
          role: 'system',
          content:
            'You translate NutsNews article cards into Japanese. Preserve meaning and warm positive tone. Use natural Japanese for a general reader. Do not add facts. Do not translate URLs or source names. Return only valid JSON.',
        },
        {
          role: 'user',
          content: `Translate this NutsNews article card into Japanese.\n\nSource: ${article.source}\nEnglish title: ${article.title}\nEnglish summary: ${article.ai_summary}\nCategory: ${article.category}\n\nReturn JSON exactly like this:\n{\n  "language_code": "ja",\n  "title": "Natural Japanese title, no added facts",\n  "summary": "Natural Japanese summary between 200 and 250 characters, no added facts"\n}`,
        },
      ],
    }),
  });
...
console.log(`Found ${candidates.length} article(s) missing Japanese summaries.`);
...
console.log(`Saved ${summaries.length} Japanese summary translation(s).`);
