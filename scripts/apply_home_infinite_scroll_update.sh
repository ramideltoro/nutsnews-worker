...
mkdir -p "$TARGET_ROOT/web/app/components" "$TARGET_ROOT/scripts"
...
echo "  cd $TARGET_ROOT && git add README.md web/app/page.tsx web/app/components/ArticleFeed.tsx scripts/apply_home_infinite_scroll_update.sh"
