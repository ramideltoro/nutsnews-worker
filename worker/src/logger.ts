...
const BETTER_STACK_DELIVERY_EVENTS = new Set([
	...
	"worker.cache.next_revalidation_unconfigured",
	"worker.cache.next_revalidation_succeeded",
	"worker.cache.next_revalidation_failed",
	"worker.cache.cloudflare_purge_unconfigured",
	"worker.cache.cloudflare_purge_succeeded",
	"worker.cache.cloudflare_purge_failed",
	"worker.cache.public_feed_invalidation_completed",
	...
	"worker.translation.local.quality_rejected",
	"worker.translation.local.quality_warning",
	...
	"worker.translation.openai.quality_rejected",
	"worker.translation.openai.quality_warning",
